import { default as __DTS_6__ } from 'ol/events/Event';
import { default as __DTS_5__ } from 'ol/renderer/Layer';
import { default as __DTS_4__, State } from 'ol/source/Source';
import { State, default as __DTS_3__ } from 'ol/layer/Layer';
import { BackgroundColor } from 'ol/layer/Base';
import { default as __DTS_2__ } from 'ol/renderer/webgl/TileLayer';
import { default as __DTS_1__, ViewStateLayerStateExtent } from 'ol/View';
import { FeatureLike } from 'ol/Feature';
import { Pixel } from 'ol/pixel';
import { EventsKey, Listener } from 'ol/events';
import { BaseTileLayerOnSignature } from 'ol/layer/BaseTile';
import { FrameState } from 'ol/Map';
import { Extent } from 'ol/extent';
import { DefineComponent, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, ExtractPropTypes, PropType, Ref } from 'vue';
import { SourceType, Style, type Options } from 'ol/layer/WebGLTile';
...
declare const _default: __VLS_WithTemplateSlots<DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<Options>, {
    ...
    tileLayer: Ref<{
        ...
        isVisible: (view?: __DTS_1__ | ViewStateLayerStateExtent | undefined) => boolean;
        getAttributions: (view?: __DTS_1__ | ViewStateLayerStateExtent | undefined) => string[];
        unrender: () => void;
        setMapInternal: (map: Map | null) => void;
        getMapInternal: () => Map | null;
        setMap: (map: Map | null) => void;
        setSource: (source: SourceType | null) => void;
        getRenderer: () => __DTS_2__ | null;
        hasRenderer: () => boolean;
        getBackground: () => false | BackgroundColor;
        getClassName: () => string;
        getLayerState: (managed?: boolean | undefined) => State;
        getLayersArray: (array?: __DTS_3__<__DTS_4__, __DTS_5__<any>>[] | undefined) => __DTS_3__<__DTS_4__, __DTS_5__<any>>[];
        ...
        dispatchEvent: (event: string | __DTS_6__) => boolean | undefined;
